...
class QueryRegularFixedQuantityConfirmation extends Model {
    ...
    public static function noPackaging($params)
    {
        try {
            ...
            $check = Model::select('code_consignee','etd_jkt','datasource')->whereIn('id',explode(',',$params->id_fixed_quantity))
            ...
            $data = Model::select(DB::raw('count(order_no) as total'),'order_no')->whereIn('id',explode(',',$params->id_fixed_quantity))
                ->groupBy('order_no')
                ->orderBy('total','desc')
                ->get()
                ->toArray();
    ...
    public static function inquiryProcess($params, $is_trasaction = true)
    {
        ...
        try {
           ...
           self::where(function ($query) use ($params){
                   $query->whereIn('id',explode(',',$params->id_fixed_quantity));
    ...
    public static function changeEtd($params,$is_trasaction = true)
    {
        ...
        try {
            ...
            $data = self::whereIn('id',explode(',',$params->id_fixed_quantity))->get();
