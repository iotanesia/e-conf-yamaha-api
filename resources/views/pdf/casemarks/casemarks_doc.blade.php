                        ...
                        <td class="text-center" style="font-size: 23px; font-weight: 500; vertical-align=top;">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="no-br no-bt text-center"><p style="padding:0 30px 0 0; margin:0;"><b>QTY</b></p> </td>
                                </tr>
                                <tr>
                                    <td class="no-br no-bb text-center"><p style="padding:0 30px 0 0; margin:0;"><b>PCS</b></p> </td>
                                </tr>
                            </table>
                            <hr>
                            <table>
                ...
                @endif
                        <tr>
                            <td class="text-center" style="font-size: 40px; font-weight: 500; vertical-align=top; padding: 20px;">
                                ...
                                <p style="margin:0 0 15px 0; padding:0;"><b>MADE IN INDONESIA</b></p>
                                <p style="margin:0 0 15px 0; padding:0;"><b>INV.No. {{ $item->no_packaging }}</b></p>
                                <p style="margin:0 0 15px 0; padding:0;"><b>C/No. : {{ $package_number[$order['order_no'].$order['cust_item_no'].$jml] }}</b></p>
                            </td>
                            <td class="text-center" style="font-size: 25px; font-weight: 500; vertical-align=top;">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-br text-center"><b>{{ round(array_sum($box_item['total_gross_weight']),2) }}</b></td>
                                    </tr>
                                    <tr>
