...
<body>
        <table>
            @if ($data->peb == null && $data->no_open == null)
                <p style="z-index: 99; position: absolute; right: 10; border: 1px solid black; padding: 2px 10px 2px 10px; margin-top: 50px;">DRAFT</p>
            @endif
            <tr>
        ...
        <table>
            <tr>
                <td style="vertical-align: top;" rowspan="2" width="240"><u>Shipper :</u> <br> {{$data->shipper_address}}</td>
            ...
            <table style="border: 1px solid #000; border-top:hidden;">
                <table>
                    <tr>
                        ...
                        <td class="no-bo" style="padding: 0 0 0 5px; margin: 0;" colspan="2"> : <b>{{$data->etd_jkt}}</b></td>
                    </tr>
                    <tr>
                        <td class="no-bo" style="padding: 0 0 0 5px; margin: 0;">Shipped By </td>
                        <td class="no-bo" style="padding: 0 0 0 5px; margin: 0;" colspan="2"> : {{$data->id_shipped_by}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="no-bo" style="padding: 0 0 0 5px; margin: 0;"> : {{$data->pol ?? $data->id_port_of_loading}}</td>
                    ...
                    <tr>
                        ...
                        <td class="no-bo" style="padding: 0 0 0 5px; margin: 0;"> : {{$data->pod ?? $data->id_port_of_discharge}}</td>
