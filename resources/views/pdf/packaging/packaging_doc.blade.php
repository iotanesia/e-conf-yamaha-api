        ...
        <hr>
                    ...
                    @foreach ($boxYPMJ as $key => $box_item)
                        @for ($i = 0; $i < count($box_item['item_no_series']); $i++)
                            <tr>
                                ...
                                <td style='padding-bottom:5px;' class='text-center'>{{ $i % 2 == 0 && $i == 0 ? array_sum($box_item['meas_ypmj']) : null }}</td>
                            </tr>
                        @endfor
                    @endforeach
                @else
            ...
            <table style="margin-top: 20px;">
                <tr>
                    ...
                    <td class="no-bo">
                        {{ $item->datasource == "YPMJ" ? (count($boxYPMJ) > 1 ? "Cartons Boxes" : "Carton Box") : ($grand_total > 1 ? "Cartons Boxes" : "Carton Box") }}
                    </td>
                </tr>
                <tr>
