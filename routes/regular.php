...
->group(function () {
    ...
    Route::group(['prefix' => 'plan'],function (){
     ...
     Route::group(['prefix' => 'delivery-plan'],function (){
        Route::get('/',[DeliveryPlanController::class,'']);
    ...
    Route::group(['prefix' => 'fixed'],function (){
        ...
        Route::group(['prefix' => 'shipping-instruction'],function (){
            ...
            Route::get('/container/detail/{id}',[FixedShippingInstructionController::class,'shippingInstructionContainerDetail']);
        ...
        Route::group(['prefix' => 'packing'],function(){
            ...
            Route::get('/export/csv/{id}',[FixedQuantityConfirmationController::class,'exportCSV']);
            Route::get('/export/peb/{id}',[FixedQuantityConfirmationController::class,'exportPEB']);
        });
